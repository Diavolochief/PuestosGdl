...
//use effect para el uso del spinner 
    ...
    return (
        //container principal
        <div className='bg-pink-500   w-full h-full  flex justify-evenly rounded-lg p-10'>
            <div className='flex justify-center flex-col m-auto sm:flex-row '>
                <img
                className='sm:w-1/2 h-1/2'
                    src={require('./assets/escudo.png')}
                    style={{ width: '50%', height: '50%', margin: 'auto' }}
                />
                <hr className='w-full  mb-9'></hr>
            ...
            <div className='w-3/4 h-1/2 ml-6  py-5 sm:w-full'>
                {loader ? (<div className='flex justify-center  py-64'>
                    <h1 className='text-white text-5xl block mr-10'>Cargando...
                    </h1>
