...
const MapView = () => {
    ...
    return (
        //container principal
        <div className='bg-pink-500 w-full h-full  flex justify-evenly  rounded-lg p-10 sm:p-5 sm:pb-0 sm:block '>
            <div className='flex justify-center flex-col m-auto'>
                ...
                <button onClick={() => obtener()} className=" mx-auto w-full h-9 text-white bg-orange-400  rounded-md hover:bg-orange-500">
                    Buscar
                </button>
            </div>
